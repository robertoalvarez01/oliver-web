...
var Filtro = function Filtro(props) {
  ...
  var activarFiltroPorUrl = function activarFiltroPorUrl() {
    if (props.query.search) {
      console.log(Object.keys(props.query)[0]);
    } else {
